...
int main()
{
	...
	Shader lightingShader("Shader/lighting.vs", "Shaders/lighting.frag");
	Shader lampShader("Shader/lamp.vs", "Shaders/lamp.frag");
	Shader SkyBoxshader("Shader/SkyBox.vs", "Shaders/SkyBox.frag");
